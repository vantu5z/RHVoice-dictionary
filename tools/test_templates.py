...
test_txt=[
    ...
    # Десятичные дроби
    ('1 236,345 567', '1236 целых 345567 миллионных'),  
    ...
    ('(1,5±0,2)×10^-9',
     '(одна целая 5 десятых плюс-минус 0 целых две десятых) на 10 '
     'в степени минус 9'),
    # Римские цифры
    ...
    ('3-кратный', 'трёхкратный'),                   # CountRule_10
    ...
    # Простые математические выражения (rules.ArithmExpr)
    ('2+2=4', '2 плюс 2 равно четырём'),
    ('6-2=4', '6 минус 2 равно четырём'),
