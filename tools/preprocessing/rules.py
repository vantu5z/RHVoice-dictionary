...
class UnitRule_2(RuleBase):
    ...
    def __init__(self):
        self.mask = (
            ...
            r'не более чем |стрельбы |пол[её]та |)в '
            r'((\d+,|)(\d+) - |)(\d+,|)(\d+)) ' + units)
...
class UnitRule_4(RuleBase):
    ...
    def __init__(self):
        self.mask = (
            ...
            r'[Дд]ости[гчатья]{1,4}|[Дд]остига?л[аио]?|[Дд]остигн[еу]т|'
...
class CardinalRule_13(RuleBase):
    ...
    def __init__(self):
        self.mask = (
            ...
            r'[Дд]остигши[еймх]|[Дд]остигавши[еймх]|[Дд]остигш[аеигмоуя]{2,3}|'
            r'[Дд]остигавш[аеигмоуя]{2,3}|[Дд]остигше[ейм|[Дд]остигавше[ейм]|'
            r'[Вв]ладел[аеимухцыь]{2,5}|[Вв]нутри|[Вв] районе|'
