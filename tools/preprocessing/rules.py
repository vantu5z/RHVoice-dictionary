...
class UnitRule_8(RuleBase):
    ...
    def __init__(self):
        self.mask = (
            r'\b(([Мм]ежду|[Сс]|[Вв]ладе[авеийлмтюшщья]{1,7}) '
...
class CardinalRule_20(RuleBase):
    ...
    def __init__(self):
        self.mask = (
            r'\b([Вв] |[Нн]а |[Оо]б? |[Пп]ри )((\d+)( [-и] | или )|)'
...
class OrdinalRule_41(RuleBase):
    ...
    Описание: Порядковые числительные. Именитльный падеж мужского рода
              совпадает сродительным/дательным/творительным/предложным
