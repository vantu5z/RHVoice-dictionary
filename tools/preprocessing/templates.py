...
samples_1 = (
  ...
  (r'[«»"]', ''), # Шеблоны не рассчитаны на присутствие кавычек
  ...
  (r'\b(в|вв|\d+ ?г|\d+-й г|гг|др|д|п|с|э|долл|руб|кв|обл|тыс|ш|шт|чел|ед|'
   r'рт\. ст)\.( [А-Я][ а-я]+|\n|\Z)', r'\1..\2'),
  ...
  #(r'\b([А-Я]\. ?([А-Я]\. ?|))([А-Я][а-я]+)\b', r'\3'), # Не читает инициалы

  # В названиях, обозначениях, номерах: правильное чтение букв и числительных
  (r'\b([A-Za-zА-Яа-я]+-\d+) ([а-яё]+)\b', r'\1_\2'),
...
samples_4 = (
  ...
  ('_', ' ') # Необязательная замена маркера (используется при обработке)
)
