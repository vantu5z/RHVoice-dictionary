...
patterns = (
  ...
  (r'\b([IVX]+)( (тысяче|сто)летия| поколения)\b', 'ordinal(roman2arabic(m.group(1)), r_sr) + m.group(2)'),
  ...
  (r'(\d+)( (квартал|класс|[Сс]ъезд|тип|этаж)(|а|е|ом|у))\b', 'ordinal(m.group(1), mu_pad[m.group(4)]) + m.group(2)'),
