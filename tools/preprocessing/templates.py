...
# Сокращенные обозначения единиц измерения «литр», «метр» и др.
# совпадают с первыми буквами данных слов, что в ряде случаев
# приводит к неправильной замене. Значок " служит маркером,
# предотвращающим ошибочную замену.
forms = {
...
presamples = (
  ...
  (r'[«»"]', ''), # Шеблоны не рассчитаны на присутствие кавычек
                  # " используется при обработке в качестве маркера
  ...
  (r'€((((\d+,|)\d+|) - |)(\d+,|)\d+) (тыс\.|млн|млрд|трлн)', r'\1_\6 €'),
  (r'(\$|€|£|₽)((((\d+,|)\d+ - )|)(\d+,|)\d+)\b', r'\2_\1'),
