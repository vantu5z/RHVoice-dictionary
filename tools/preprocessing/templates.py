...
forms = {
  ...
  'млн':  ('миллион', 'миллионов', 'миллиона', 'миллионов', 'миллиону',
           'миллионам', 'миллионом', 'миллионами', 'миллионе', 'триллионах',
           'триллиона'),
...
presamples = (
  ...
  (r'\b(\d+-)мм( [а-яё]+(ая|о[ей]|ого|ому?|ую|ы([йх]|ми?)))\b', r'\1миллиметров\3\2'),
...
# Основы прилагательных, в состав которых входят числительные, напр. "3-кратный"
adjectiv = ('долларов', 'рублев', 'рублёв', 'часов', 'градусн', 'мерн', 'сильн',
            'ствольн', 'тонн', 'канальн', 'страничн', 'тысячн', 'миллионн',
            'миллиардн', 'процентн', 'секундн', 'минутн', 'месячн', 'недельн',
            'дневн', 'кратн', 'местн', 'мильн', 'этажн', 'летн', 'микронн',
            'килограммов', 'миллиграммов', 'километров', 'миллиметров',
            'сантиметров', 'метров')
...
pre_acc = ('вес', 'веса', 'весе', 'весу', 'весом',
           ...
           'оцените', 'оценят', 'оценив', 'оценивая')
