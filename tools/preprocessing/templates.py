...
samples_3 = (
  ...
  (r'(\d+)( зимни[еимх]{1,2}| летни[еимх]{1,2}|)( Олимпийски)(е|ми|м\b|х)\b',
   ...
   'm.group(4)'),
  (r'(\d+0)( (-|и|или) \d+0-е годы)', 'ordinal(m.group(1), i_mn) + m.group(2)'),
  ...
  (r'(\d+)(|-й) (или|и|-) (\d+)(|-й) (годы|гг\.)',
   'ordinal(m.group(1), i_mu) + " " + m.group(3) + " " + '
   'ordinal(m.group(4), i_mu) + " годы"'),
...
pre_acc = ('бюджет', 'бюджета', 'бюджете', 'бюджету', 'бюджетом',
           ...
           'скоростей', 'скоростям', 'скоростями', 'скоростях',
