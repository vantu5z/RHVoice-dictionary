...
samples = (
  ...
  (r'(([Вв]|[Оо]) \d+)( (-|или(| [во]))( \d+)) в\.', r'\1-м\3-м веке'),
  (r'(([Вв]|[Оо]) \d+)( (-|и(| [во])) \d+) вв\.', r'\1-м\3-м веках'),
...
# pre_gen + римские цифры + существительное -> родительный падеж
pre_gen = ('до', 'после', 'позднее', 'ранее', 'около', 'с', 'начало', 'начала',
           'начале', 'началу', 'началом', 'середина', 'середине', 'середину',
           'середины', 'серединой', 'конец', 'конца', 'концу', 'конце',
           'концом', 'половина', 'половины', 'половине', 'половину',
           'треть', 'трети', 'третью', 'четверть', 'четверти', 'четвертью')
