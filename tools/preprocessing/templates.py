...
samples_1 = (
  ...
  (r'\b(\d+)' + units, r'\1 \2'),
  (r'\b(\d+)\.(\d+) ?' + units, r'\1,\2 \3'), # Точка в десятичных дробях
  (r'(\d ?тыс\.)' + units, r'\1 \2'), # Редкий случай
...
pre_acc = ('бюджет', 'бюджета', 'бюджете', 'бюджету', 'бюджетом',
           ...
           'оцените', 'оценят', 'оценив', 'оценивая', 'оценивается', 'оцениваться',
           'оценивался', 'оценивалась', 'оценивалось', 'оценивались', 'оцениваются',
           'оценивают', 'оценивает')
