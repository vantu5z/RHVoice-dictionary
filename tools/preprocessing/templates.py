...
units = (r"(%|°|'|℃|В\b|К\b|М\b|£|₽|\$|(|к|М|Г)(Гц|пк)|(к|м)г\b|кВт⋅ч\b|"
         r"(|мк|к|с|м)м\b|(|к|с|м)м²|(|к|с|м)м³|(|к|М)т\b|(|к|М|Г)Вт\b|га\b|"
         r"сек\b|л\.с\.|л\b|а\.е\.|шт\.|ед\.|тыс\.|млн|млрд|трлн)")
zh_units = ('т', 'кт', 'Мт', 'а.е.', 'л.с.', 'сек', "'", 'ед.', 'тыс.', 'шт.')
...
forms = {
  ...
  'кВт⋅ч': ('киловатт-час', 'киловатт-часов', 'киловатт-часа',
            'киловатт-часов', 'киловатт-часу', 'киловатт-часам',
            'киловатт-часом', 'киловатт-часами', 'киловатт-часе',
            'киловатт-часах', 'киловатт-часа')
}
...
samples_2 = (
  ...
  (r'\b([Вв] \d+)(((, (а|но) не в)| или(| в)| -) \d+) (году|г\.)',
   r'\1-м\2-м году'),
