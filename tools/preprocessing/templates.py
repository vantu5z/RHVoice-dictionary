...
samples_3 = (
  ...
  (r'\b([Пп]о сравнению с |[Вв]ладе[авеийлмтюшщья]{1,7} )(\d+),(\d+)\b',
   'm.group(1) + fraction(m.group(2), m.group(3), 3)'),
  (r'\b([Кк] |рав[аеоын]{2} |равня[аеилостья]{3,4} )(\d+),(\d+)\b',
   'm.group(1) + fraction(m.group(2), m.group(3), 2)'),
  (r'\b([Оо]б? |[Пп]ри )(\d+),(\d+)\b',
   'm.group(1) + fraction(m.group(2), m.group(3), 4)'),
  (r'\b([Вв] )(\d+),(\d+) раза\b',
   'm.group(1) + fraction(m.group(2), m.group(3), 5) + " раза"'),
  (r'\b([Вв] )(\d+),(\d+) - (\d+),(\d+) раза\b',
   'm.group(1) + fraction(m.group(2), m.group(3), 5) + " - " + '
   'fraction(m.group(4), m.group(5), 5) + " раза"'),
  (r'\b([Дд]иаметр[аеуом]{,2}|[Рр]азниц[аейуы]{1,2}|[Вв]ысот[аейоуы]{1,2}|'
   ...
   'm.group(1) + " в " + fraction(m.group(2), m.group(3), 5)'),
#  (r'\b([Вв] )(\d+),(\d+)\b',
#   'm.group(1) + fraction(m.group(2), m.group(3), 4)'),
