...
samples_1 = (
  ...
  (r'\b([Дд]атир[авеийлностушщыя]{2,9} \d+( (или|и|-) \d+|))' + months,
   r'\1 _\4'),
  (r'\b(\d+)( [-и] | или )(\d+)' + months, r'\1-го\2\3-го \4'),
  (r'\b(\d+)' + months, r'\1-го \2'),
  (r'\b([Дд]атир[авеийлностушщыя]{2,9} \d+ (или|и|-) \d+ )гг\.',
   r'\1годами'),
  (r'\b([Дд]атир[авеийлностушщыя]{2,9} \d+ ((или|и|-) \d+ |))г\.',
   r'\1годом'),
  # Старый стиль
...
samples_3 = (
  ...
  (r'\b([Дд]атир[авеийлностушщыя]{2,9} \d+( [-и] | или ))(\d+)\b',
   'm.group(1) + ordinal(m.group(3), t_mu)'),
  (r'\b([Дд]атир[авеийлностушщыя]{2,9} )(\d+)\b',
