...
presamples = (
  ...
  (r'\n{2,}', r'\n'), # Удаление пустых строк (не обязательно)
...
samples = (
  ...
  (r'([Дд]о|[Нн]е позднее|[Нн]е ранее|[Оо]коло|[Пп]осле|[Нн]ачиная с|([Нн]ачал|[Кк]онц)(а|е|ом?|у)|[Кк]онец|([Сс]ередин|[Пп]оловин)(а|е|ой|у|ы)|трет[иь]|четверт[иь])( \d+) в\.', r'\1\6-го века'),
