...
units = (r"(%|°|'|℃|В\b|К\b|М\b|£|₽|\$|(|к|М|Г)(Гц|пк)|(к|м)г\b|кВт⋅ч\b|ч\b|"
...
forms = {
  ...
  'ч':     ('час', 'часов', 'часа', 'часов', 'часу', 'часам',
            'часом', 'часами', 'часе', 'часах', 'часа'),
...
samples_2 = (
  ...
  (r'(([Нн]ачал|[Кк]онц)(а|е|ом|у)|([Сс]ередин|[Пп]оловин)(а|е|ой|у|ы)'
   r'|[Кк]онец)( \d+0) гг\.', r'\1\6-х годов'),
