...
units = r"(%|°|'|℃|В\b|К\b|М\b|£|₽|\$|(|к|М|Г)(Гц|пк)|(к|м)г\b|(|мк|к|с|м)м\b|(|к|с|м)м²|(|к|с|м)м³|(|к|М)т\b|(|к|М|Г)Вт\b|га\b|сек\b|л\.с\.|л\b|а\.е\.|шт\.|ед\.|тыс\.|млн|млрд|трлн)"
...
presamples = (
  ...
  (r'\$(((\d+,|)\d+|)[+-]?(\d+,|)\d+) (тыс\.|млн|млрд|трлн)', r'\1_\5 долларов'),
  (r'€(((\d+,|)\d+|)[+-]?(\d+,|)\d+) (тыс\.|млн|млрд|трлн)', r'\1_\5 €'),
  (r'£(((\d+,|)\d+|)[+-]?(\d+,|)\d+) (тыс\.|млн|млрд|трлн)', r'\1_\5 фунтов стерлингов'),
  (r'₽(((\d+,|)\d+|)[+-]?(\d+,|)\d+) (тыс\.|млн|млрд|трлн)', r'\1_\5 рублей'),
  (r'(?<!\d )(\$|€|£|₽) (?=\d)', r'\1'),
  (r'(\$|€|£|₽)((((\d+,|)\d+ ?- ?)|)(\d+,|)\d+)\b', r'\2_\1'),
...
samples = (
  ...
  (r'([Дд]о|[Нн]е позднее|[Нн]е ранее|[Оо]коло|[Пп]осле|[Нн]ачиная с|([Нн]ачал|[Кк]онц)(а|е|ом?|у)|[Кк]онец|([Сс]ередин|[Пп]оловин)(а|е|ой|у|ы)|трет[иь]|четверт[иь]|[Сс])( \d+) в\.', r'\1\6-го века'),
  ...
  (r'(([Вв] течение|[Дд]о|[Нн]а протяжении|[Пп]осле) \d+)( - \d+) вв\.', r'\1-го\3-го веков'),
...
patterns = (
  ...
  (r'\b([IVX]+)( ((тысяче|сто)лети| поколени)(ем?|я|ю|и))\b', 'ordinal(roman2arabic(m.group(1)), sr_pad[m.group(5)]) + m.group(2)'),
  (r'\b([IVX]+)( (век|квартал|класс|ранг|[Сс]ъезд|тип)(|а|е|у|ом))\b', 'ordinal(roman2arabic(m.group(1)), mu_pad[m.group(4)]) + m.group(2)'),
  (r'\b([Вв] |[Оо]б? )([IVX]+) ', 'm.group(1) + ordinal(roman2arabic(m.group(2)), p_mu) + " "'),
  ...
  (r'\b(\d*1\d|\d*[02-9]?[02-9])( (век|квартал|класс|[Сс]ъезд|тип|этаж)(|а|е|ом|у))\b', 'ordinal(m.group(1), mu_pad[m.group(4)]) + m.group(2)'),
  ...
  (r'(11|[02-9])( ((тысяче|сто)лети|поколени)(е|и|ем|ю))\b', 'ordinal(m.group(1), sr_pad[m.group(5)]) + m.group(2)'),
