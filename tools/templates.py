...
def txt_prep(text):
    ...
    for m in finditer(r'\b([Пп]ри )(\d+)( [а-я]+)(ах|е|и)\b', text):
...
#        text = text.replace(m.group(), cardinal(m.group(1), r_ca), 1)
    ...
    for m in finditer(r'(\d+) ' + zh_gen, text):
