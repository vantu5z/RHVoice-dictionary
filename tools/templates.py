...
#  ('⁻', 'минус '),
  ...
  (r'([Рр]асстояни[еимя]{1,2}|[Дд]истанци[еийюя]{1,2}) (в|до)( \d+) ((|кило|санти|милли)метр)(|а|ов)\b', r'\1 \2\3_\4\6'),
  (r'\b([Вв] \d+ )((|кило|санти|милли)метр)\b', r'\1\2е'),
  (r'\b([Вв] \d+ )((|кило|санти|милли)метр)(а|ов)\b', r'\1\2ах'),
  (r'\b([Дд]о \d+ )((|кило|санти|милли)метр|(|кило|милли)грамм)\b', r'\1\2а'),
  (r'\b([Дд]о \d+ )((|кило|санти|милли)метр|(|кило|милли)грамм)а', r'\1\2ов'),
...
#        text = text.replace(m.group(), m.group(1) + ' ' + minutes, 1)
    ...
    for m in finditer(r'\b([Бб]олее|[Мм]енее|[Оо]коло|[Сс]выше|[Дд]ля|[Дд]о|[Ии]з|[Оо]т|[Бб]ез|[Уу]|[Вв] течение|[Пп]орядка|[Пп]осле|[Пп]ротив|достиг[алнш][веиотуьщюя]{1,4}|[Вв]озраст[аемоу]{,2}) (\d+) ([а-я]+)\b', text):
