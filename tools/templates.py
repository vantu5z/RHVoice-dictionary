...
ms_r = '|человека|года|времени|дела|раза|глаза|дна|друга|дома|слова|места|лица|конца|часа|голоса|города|стола|ребенка|отца|случая|вида|ряда|начала|вопроса|товарища|окна|утра|вечера|народа|плеча|взгляда|пальца|сына|леса|имени|разговора|тела|старика|пути|месяца|языка|сердца|мальчика|неба|образа|письма|брата|солдата|хозяина|начальника|парня|солнца|шага|мужчину|капитана|чувства|берега|генерала|момента|труда|мужа|движения|ответа|дерева|сна|смысла|двора|угла|века|кармана|немца|дяди|огня|писателя|состояния|зуба|камня|гостя|закона|моря|врача|действия|хода|номера|командира|героя|государства|средства|положения|класса|профессора|господина|плана|зала|директора|результата|следа|условия|процесса|центра|числа|рубля|удара|телефона|коридора|мужика|автора|кабинета|документа|самолета|рассказа|врага|доктора|лейтенанта|счета|решения|романа|течения|метра|института|качества|боя|деда|родителя|рода|звука|магазина|президента|поэта|события|листа|офицера|уровня|кресла|банка|опыта|правила|члена|десятка|цветка|желания|дождя|ящика|этажа|соседа|выхода|совета|дурака|союза|цвета|стула|поезда|поля|типа|суда|органа|короля|полковника|сада|правительства|названия|примера|зеркала|факта|учителя|круга|папы|повода|лагеря|корабля|мнения|километра|острова|гражданина|заболевания|фронта|района|выражения|мешка|управления|приказа|куста|художника|знака|завода|стакана|курса|чуда|здания|срока|материала|крика|автомата|студента|очка|ножа|предмета|майора|инженера|костюма|театра|танка|журнала|коня|ключа|вагона|бойца|фильма|обстоятельства|штаба|председателя|периода|организма|отдела|значения|билета|состава|способа|евреа|министра|принципа|направления|мастера|существа|мальчишка|замка|рынка|клуба|читателя|сотрудника|царя|зверя|размера|жителя|секретаря|приема|противника|образования|продукта|представителя|производства|ресторана|дивана|процента|автобуса|автомобиля|отряда|занятия|артиста|явления|пистолета|актера|мгновения|праздника|моста|участка|меча|звонока|адреса|костер|кота|быка|текста|волка|приятеля|дедушка|воспоминания|тона|понятия|нарушения|платьа|представления|изменения|варианта|шофера|входа|чиновника|аппарата|дворца|водителя|множества|столика|урока|работника|долга|специалиста|телевизора|старшины|озера|чемодана|предела|музеа|пятна|ученика|родственника|источника|колеса|экрана|руководителя|инспектора|предложения|списока|ствола|основания|усилия|вывода|предприятия|подарка|отделения|выстрела|трупа|признака|слоя|милиционера|портрета|шкафа|веса|русскома|убийства|хозяйства|парка|режима|преступления|полка|забора|поста|университета|журналиста|раствора|появления|облака|помещения|плаща|подъезда|следователя|платка|исследования|пункта|расстояния|кружка|поколения|фонаря|пояса|вокзала|вещества|корня|потока|пиджака|взрыва|пастуха|крыльца|вожда|кольца|медведа|проекта|паспорта|коллега|луча|коммуниста|домика|отличия|песа|орудия|молодца|собрания|слона|юноша|объекта|сравнения|океана|поселока|заявления|поражения|топора|элемента|одеяла|мотора|креста|пальта|таланта|ведра|крестьянина|поворота|столба|канала|пассажира|устройства|товара|разведчика|храма|расчета|огорода|шара|открытия|ордена|корпуса|склада|компьютера|холма|ремня|произведения|помощника|полета|пожара|симптома|свидетеля|халата|сообщения|гроба|жеста|шосса|подвала|гриба|памятника|механизма|исключения|сигнала|больном|вертолета|лекарства|кладбища|перехода|пулемета|батальона|грузовика|императора|инструмента|ружьа|участника|задания|пера|судьа|листка|яблока|путешествия|депутата|американца|следствия|яйца|поступка|преступника|звания|контакта|жука|шеф|гения|колхоза|лука|городка|бандита|москвича|пакета|зайца|танца|княза|воина|стрелка|комитета|объяснения|вора|внука|льва|огонек|редактора|режиссера|шанса|наблюдения|клиента|двигателя|рыбака|взвода|альбома|болота|снаряда|заместителя|концерта|ангела|разрешения|этапа|козла|возвращения|идиота|летчика|государя|моряка|бревна|прибора|кандидата|портфеля|малыша|назначения|гвозда|кафа|убийца|отеля|ковер|прокурора|карандаша|принца|лидера|иностранца|попа|требования|вызова|спутника|применения|распоряжения|галстука|госпиталя|училища|стука|скандала|отпуска|кадра|сиденьа|брака|проявления|такси|владелца|плода|заседания|патрона|агента|супруга|комиссара|свидания|кролика|политика|кусочек|старичка|порта|комплекса|музыканта|договора|похода|препарата|недостатка|министерства|труса|заключения|экзамена|охотника|судна|туалета|парохода|рыцаря|академика|аккумулятора|собеседника|зрителя|военнома|лифта|отчета|сарая|прохода|воробьа|рассвета|глотка|доказательства|узел|комбата|воздействия|кирпича|глазка|туриста|обмена|перевода|уголка|блюда|свойства|приключения|штата|олня|бригадира|жениха|орел|дневника|проводника|фактора|отказа|волшебника|указания|доклада|окончания|конфликта|ногта|сосуда|достижения|колдуна|наряда|рисунка|наказания|съезда|акта|посетителя|выступления|издания|соображения|кузнеца|балкона|допроса|спектакля|блока|окошка|сюжета|осколка|цеха|металла|фонда|корреспондента|окружения|предка|анекдота|общежития|штурмана|монаха|ручьа|переулка|подъема|издательства|сопротивления|сочинения|нападения|подростка|экипажа|слуга|поцелуа|черепа|дружка|учреждения|курсанта|эксперимента|барина|петуха|любителя|чеченца|исполнения|адвоката|боцмана|барака|архива|базара|рубежа|монастыря|пришелца|гнома|конверта|люка|аэропорта|подполковника|налога|полотенца|фашиста|флота|техника|охранника|барона|коменданта|квартала|приступа|определения|образца|напитка|чтения|оврага|оркестра|визита|большевика|термина|интервьа|гаража|кризиса|совещания|живом|котелка|ремонта|авторитета|провода|англичанина|наступления|объема|щита|стада|признания|мага|обращения|гена|пузыря|испытания|прыжка|коллектива|хора|заказа|свидетельства|деятеля|бокала|крана|проспекта|братца|маршрута|ареста|китаца|капитала|заключеннома|описания|замысел|хутора|матроса|сынка|ноля|протокола|трамвая|маршала|интеллигента|пустяка|растения|советника|преимущества|велосипеда|колодца|кончика|холодильника|исхода|стихотворения|перерыва|губернатора|яда|хоббита|бинокля|килограмма|марша|чайника|трактора|замечания|раба|заведения|знамя|фрукта|мотоцикла|мероприятия|чина|шпиона|дуба|столетия|партизана|незнакомца|младенца|эпизода|преподавателя|племя|тома|диск|пациента|оттенка|гуса|инвалида|боевика|очага|француза|отражения|котел|сценария|официанта|обвинения|школьника|рюкзака|осел|барана|оборота|купола|приглашения|пионера|приговора|побега|учебника|котенка|порошка|посольства|окурка|мяча|аэродрома|разряда|объявления|десятилетия|пейзажа|огурца|пацана|партнера|шлема|продавца|гнезда|казака|пруда|блокнота|лозунга|покойника|снимка|священника|обитателя|отверстия|набора|разбойника|танцора|утверждения|конкурса|толчка|батюшка|салона|бака|сантиметра|грамма|пилота|рабочема|предположения|покупателя|градуса|комара|флага|всадника|барьера|историка|дымка|офиса|повара|негодяа|прогноза|провала|негра|дровосека|введения|округа|переводчика|японца|горшка|плаката|сорта|фонарика|мундира|профессионала|катера|шарика|бассейна|метода|человечека|красавца|правителя|заряда|ребра|обломка|диплома|указа|обещания|чудака|паренек|семейства|царства|фонтана|жилца|расследования|удава|выпуска|хирурга|символа|развода|заведующема|региона|защитника|сектора|санитара|грека|потомка|сочетания|постановления|самоубийства|сейфа|блина|предателя|купца|демократа|факультета|солдатика|паровоза|призрака|собора|соединения|скафандра|особняка|изделия|землянина|строения|диагноза|чудовища|букета|кредита|эшелона|копьа|матча|щенка|тигра|аргумента|полотна|пропуска|микрофона|игрока|новичка|парнишка|поручения|торговца|строителя|знакомома|слушателя|'

ms_d = '|человеку|году|времени|делу|разу|глазу|дню|другу|дому|слову|месту|лицу|концу|часу|голосу|городу|столу|ребенку|отцу|случаю|виду|ряду|началу|вопросу|товарищу|окну|утру|вечеру|народу|плечу|взгляду|пальцу|сыну|лесу|имени|разговору|телу|старику|пути|месяцу|языку|сердцу|мальчику|небу|образу|письму|брату|солдату|хозяину|начальнику|парню|солнцу|шагу|мужчине|капитану|чувству|берегу|генералу|моменту|труду|мужу|движению|ответу|дереву|сну|смыслу|двору|углу|веку|карману|немцу|дяде|огню|писателю|состоянию|зубу|камню|гостю|закону|морю|врачу|действию|ходу|номеру|командиру|герою|государству|средству|положению|классу|профессору|господину|плану|залу|директору|результату|следу|условию|процессу|центру|числу|рублю|удару|телефону|коридору|мужику|автору|кабинету|документу|самолету|рассказу|врагу|доктору|лейтенанту|счету|решению|роману|течению|метру|институту|качеству|бою|деду|родителю|роду|звуку|магазину|президенту|поэту|событию|листу|офицеру|уровню|креслу|банку|опыту|правилу|члену|десятку|цветку|желанию|дождю|ящику|этажу|соседу|выходу|совету|дураку|союзу|цвету|стулу|поезду|полу|типу|суду|органу|королю|полковнику|саду|правительству|названию|примеру|зеркалу|факту|учителю|кругу|папе|поводу|лагерю|кораблю|мнению|километру|острову|гражданину|заболеванию|фронту|району|выражению|мешку|управлению|приказу|кусту|художнику|знаку|заводу|стакану|курсу|чуду|зданию|сроку|материалу|крику|автомату|студенту|очку|ножу|предмету|майору|инженеру|костюму|театру|танку|журналу|коню|ключу|вагону|бойцу|фильму|обстоятельству|штабу|председателю|периоду|организму|отделу|значению|билету|составу|способу|еврею|министру|принципу|направлению|мастеру|существу|мальчишке|замку|рынку|клубу|читателю|сотруднику|царю|зверю|размеру|жителю|секретарю|приему|противнику|образованию|продукту|представителю|производству|ресторану|дивану|проценту|автобусу|автомобилю|отряду|занятию|артисту|явлению|пистолету|актеру|мгновению|празднику|мосту|участку|мечу|звоноку|адресу|костер|коту|быку|тексту|волку|приятелю|дедушке|воспоминанию|тону|понятию|нарушению|платью|представлению|изменению|варианту|шоферу|входу|чиновнику|аппарату|дворцу|водителю|множеству|столику|уроку|работнику|долгу|специалисту|телевизору|старшине|озеру|чемодану|пределу|музею|пятну|ученику|родственнику|источнику|колесу|экрану|руководителю|инспектору|предложению|списоку|стволу|основанию|усилию|выводу|предприятию|подарку|отделению|выстрелу|трупу|признаку|слою|милиционеру|портрету|шкафу|весу|русскому|убийству|хозяйству|парку|режиму|преступлению|полку|забору|посту|университету|журналисту|раствору|появлению|облаку|помещению|плащу|подъезду|следователю|платку|исследованию|пункту|расстоянию|кружку|поколению|фонарю|поясу|вокзалу|веществу|корню|потоку|пиджаку|взрыву|пастуху|крыльцу|вождю|кольцу|медведю|проекту|паспорту|коллеге|лучу|коммунисту|домику|отличию|песу|орудию|молодцу|собранию|слону|юноше|объекту|сравнению|океану|поселоку|заявлению|поражению|топору|элементу|одеялу|мотору|кресту|пальту|таланту|ведру|крестьянину|повороту|столбу|каналу|пассажиру|устройству|товару|разведчику|храму|расчету|огороду|шару|открытию|ордену|корпусу|складу|компьютеру|холму|ремню|произведению|помощнику|полету|пожару|симптому|свидетелю|халату|сообщению|гробу|жесту|шоссу|подвалу|грибу|памятнику|механизму|исключению|сигналу|больному|вертолету|лекарству|кладбищу|переходу|пулемету|батальону|грузовику|императору|инструменту|ружью|участнику|заданию|перу|судье|листку|яблоку|путешествию|депутату|американцу|следствию|яйцу|поступку|преступнику|званию|контакту|жуку|шеф|гению|колхозу|луку|городку|бандиту|москвичу|пакету|зайцу|танцу|князю|воину|стрелку|комитету|объяснению|вору|внуку|льву|огонькц|редактору|режиссеру|шансу|наблюдению|клиенту|двигателю|рыбаку|взводу|альбому|болоту|снаряду|заместителю|концерту|ангелу|разрешению|этапу|козлу|возвращению|идиоту|летчику|государю|моряку|бревну|прибору|кандидату|портфелю|малышу|назначению|гвоздю|кафу|убийце|отелю|ковер|прокурору|карандашу|принцу|лидеру|иностранцу|попу|требованию|вызову|спутнику|применению|распоряжению|галстуку|госпиталю|училищу|стуку|скандалу|отпуску|кадру|сиденью|браку|проявлению|такси|владелцу|плоду|заседанию|патрону|агенту|супругу|комиссару|свиданию|кролику|политику|кусочек|старичку|порту|комплексу|музыканту|договору|походу|препарату|недостатку|министерству|трусу|заключению|экзамену|охотнику|судну|туалету|пароходу|рыцарю|академику|аккумулятору|собеседнику|зрителю|военному|лифту|отчету|сараю|проходу|воробью|рассвету|глотку|доказательству|узел|комбату|воздействию|кирпичу|глазку|туристу|обмену|переводу|уголку|блюду|свойству|приключению|штату|олню|бригадиру|жениху|орел|дневнику|проводнику|фактору|отказу|волшебнику|указанию|докладу|окончанию|конфликту|ногтю|сосуду|достижению|колдуну|наряду|рисунку|наказанию|съезду|акту|посетителю|выступлению|изданию|соображению|кузнецу|балкону|допросу|спектаклю|блоку|окошку|сюжету|осколку|цеху|металлу|фонду|корреспонденту|окружению|предку|анекдоту|общежитию|штурману|монаху|ручью|переулку|подъему|издательству|сопротивлению|сочинению|нападению|подростку|экипажу|слуге|поцелую|черепу|дружку|учреждению|курсанту|эксперименту|барину|петуху|любителю|чеченцу|исполнению|адвокату|боцману|бараку|архиву|базару|рубежу|монастырю|пришелцу|гному|конверту|люку|аэропорту|подполковнику|налогу|полотенцу|фашисту|флоту|технику|охраннику|барону|коменданту|кварталу|приступу|определению|образцу|напитку|чтению|оврагу|оркестру|визиту|большевику|термину|интервью|гаражу|кризису|совещанию|живому|котелку|ремонту|авторитету|проводу|англичанину|наступлению|объему|щиту|стаду|признанию|магу|обращению|гену|пузырю|испытанию|прыжку|коллективу|хору|заказу|свидетельству|деятелю|бокалу|крану|проспекту|братцу|маршруту|аресту|китацу|капиталу|заключенному|описанию|замысел|хутору|матросу|сынку|нолю|протоколу|трамваю|маршалу|интеллигенту|пустяку|растению|советнику|преимуществу|велосипеду|колодцу|кончику|холодильнику|исходу|стихотворению|перерыву|губернатору|яду|хоббиту|биноклю|килограмму|маршу|чайнику|трактору|замечанию|рабу|заведению|знамя|фрукту|мотоциклу|мероприятию|чину|шпиону|дубу|столетию|партизану|незнакомцу|младенцу|эпизоду|преподавателю|племя|тому|диск|пациенту|оттенку|гусю|инвалиду|боевику|очагу|французу|отражению|котел|сценарию|официанту|обвинению|школьнику|рюкзаку|осел|барану|обороту|куполу|приглашению|пионеру|приговору|побегу|учебнику|котенку|порошку|посольству|окурку|мячу|аэродрому|разряду|объявлению|десятилетию|пейзажу|огурцу|пацану|партнеру|шлему|продавцу|гнезду|казаку|пруду|блокноту|лозунгу|покойнику|снимку|священнику|обитателю|отверстию|набору|разбойнику|танцору|утверждению|конкурсу|толчку|батюшке|салону|баку|сантиметру|грамму|пилоту|рабочему|предположению|покупателю|градусу|комару|флагу|всаднику|барьеру|историку|дымку|офису|повару|негодяю|прогнозу|провалу|негру|дровосеку|введению|округу|переводчику|японцу|горшку|плакату|сорту|фонарику|мундиру|профессионалу|катеру|шарику|бассейну|методу|человечеку|красавцу|правителю|заряду|ребру|обломку|диплому|указу|обещанию|чудаку|паренек|семейству|царству|фонтану|жилцу|расследованию|удаву|выпуску|хирургу|символу|разводу|заведующему|региону|защитнику|сектору|санитару|греку|потомку|сочетанию|постановлению|самоубийству|сейфу|блину|предателю|купцу|демократу|факультету|солдатику|паровозу|призраку|собору|соединению|скафандру|особняку|изделию|землянину|строению|диагнозу|чудовищу|букету|кредиту|эшелону|копью|матчу|щенку|тигру|аргументу|полотну|пропуску|микрофону|игроку|новичку|парнишке|поручению|торговцу|строителю|знакомому|слушателю|'

ms_p = '|человеке|году|годе|времени|деле|разе|глазе|дне|друге|доме|слове|месте|лице|конце|часу|часе|голосе|городе|столе|ребенке|отце|случае|виде|ряде|начале|вопросе|товарище|окне|утре|вечере|народе|плече|взгляде|пальце|сыне|лесе|имени|разговоре|теле|старике|пути|месяце|языке|сердце|мальчике|небе|образе|письме|брате|солдате|хозяине|начальнике|парне|солнце|шаге|мужчине|капитане|чувстве|береге|генерале|моменте|труде|муже|движении|ответе|дереве|сне|смысле|дворе|угле|веке|кармане|немце|дяде|огне|писателе|состоянии|зубе|камне|госте|законе|море|враче|действии|ходе|номере|командире|герое|государстве|средстве|положении|классе|профессоре|господине|плане|зале|директоре|результате|следе|условии|процессе|центре|числе|рубле|ударе|телефоне|коридоре|мужике|авторе|кабинете|документе|самолете|рассказе|враге|докторе|лейтенанте|счете|решении|романе|течении|метре|институте|качестве|бое|деде|родителе|роде|звуке|магазине|президенте|поэте|событии|листе|офицере|уровне|кресле|банке|опыте|правиле|члене|десятке|цветке|желании|дожде|ящике|этаже|соседе|выходе|совете|дураке|союзе|цвете|стуле|поезде|поле|типе|суде|органе|короле|полковнике|саде|правительстве|названии|примере|зеркале|факте|учителе|круге|папе|поводе|лагере|корабле|мнении|километре|острове|гражданине|заболевании|фронте|районе|выражении|мешке|управлении|приказе|кусте|художнике|знаке|заводе|стакане|курсе|чуде|здании|сроке|материале|крике|автомате|студенте|очке|ноже|предмете|майоре|инженере|костюме|театре|танке|журнале|коне|ключе|вагоне|бойце|фильме|обстоятельстве|штабе|председателе|периоде|организме|отделе|значении|билете|составе|способе|еврее|министре|принципе|направлении|мастере|существе|мальчишке|замке|рынке|клубе|читателе|сотруднике|царе|звере|размере|жителе|секретаре|приеме|противнике|образовании|продукте|представителе|производстве|ресторане|диване|проценте|автобусе|автомобиле|отряде|занятии|артисте|явлении|пистолете|актере|мгновении|празднике|мосте|участке|мече|звоноке|адресе|костер|коте|быке|тексте|волке|приятеле|дедушке|воспоминании|тоне|понятии|нарушении|платье|представлении|изменении|варианте|шофере|входе|чиновнике|аппарате|дворце|водителе|множестве|столике|уроке|работнике|долге|специалисте|телевизоре|старшине|озере|чемодане|пределе|музее|пятне|ученике|родственнике|источнике|колесе|экране|руководителе|инспекторе|предложении|списоке|стволе|основании|усилии|выводе|предприятии|подарке|отделении|выстреле|трупе|признаке|слое|милиционере|портрете|шкафе|весе|русскоме|убийстве|хозяйстве|парке|режиме|преступлении|полке|заборе|посте|университете|журналисте|растворе|появлении|облаке|помещении|плаще|подъезде|следователе|платке|исследовании|пункте|расстоянии|кружке|поколении|фонаре|поясе|вокзале|веществе|корне|потоке|пиджаке|взрыве|пастухе|крыльце|вожде|кольце|медведе|проекте|паспорте|коллеге|луче|коммунисте|домике|отличии|песе|орудии|молодце|собрании|слоне|юноше|объекте|сравнении|океане|поселоке|заявлении|поражении|топоре|элементе|одеяле|моторе|кресте|пальте|таланте|ведре|крестьянине|повороте|столбе|канале|пассажире|устройстве|товаре|разведчике|храме|расчете|огороде|шаре|открытии|ордене|корпусе|складе|компьютере|холме|ремне|произведении|помощнике|полете|пожаре|симптоме|свидетеле|халате|сообщении|гробе|жесте|шоссе|подвале|грибе|памятнике|механизме|исключении|сигнале|больном|вертолете|лекарстве|кладбище|переходе|пулемете|батальоне|грузовике|императоре|инструменте|ружье|участнике|задании|пере|судье|листке|яблоке|путешествии|депутате|американце|следствии|яйце|поступке|преступнике|звании|контакте|жуке|шеф|гении|колхозе|луке|городке|бандите|москвиче|пакете|зайце|танце|князе|воине|стрелке|комитете|объяснении|воре|внуке|льве|огонек|редакторе|режиссере|шансе|наблюдении|клиенте|двигателе|рыбаке|взводе|альбоме|болоте|снаряде|заместителе|концерте|ангеле|разрешении|этапе|козле|возвращении|идиоте|летчике|государе|моряке|бревне|приборе|кандидате|портфеле|малыше|назначении|гвозде|кафе|убийце|отеле|ковер|прокуроре|карандаше|принце|лидере|иностранце|попе|требовании|вызове|спутнике|применении|распоряжении|галстуке|госпитале|училище|стуке|скандале|отпуске|кадре|сиденье|браке|проявлении|такси|владелце|плоде|заседании|патроне|агенте|супруге|комиссаре|свидании|кролике|политике|кусочек|старичке|порте|комплексе|музыканте|договоре|походе|препарате|недостатке|министерстве|трусе|заключении|экзамене|охотнике|судне|туалете|пароходе|рыцаре|академике|аккумуляторе|собеседнике|зрителе|военноме|лифте|отчете|сарае|проходе|воробье|рассвете|глотке|доказательстве|узел|комбате|воздействии|кирпиче|глазке|туристе|обмене|переводе|уголке|блюде|свойстве|приключении|штате|олне|бригадире|женихе|орел|дневнике|проводнике|факторе|отказе|волшебнике|указании|докладе|окончании|конфликте|ногте|сосуде|достижении|колдуне|наряде|рисунке|наказании|съезде|акте|посетителе|выступлении|издании|соображении|кузнеце|балконе|допросе|спектакле|блоке|окошке|сюжете|осколке|цехе|металле|фонде|корреспонденте|окружении|предке|анекдоте|общежитии|штурмане|монахе|ручье|переулке|подъеме|издательстве|сопротивлении|сочинении|нападении|подростке|экипаже|слуге|поцелуе|черепе|дружке|учреждении|курсанте|эксперименте|барине|петухе|любителе|чеченце|исполнении|адвокате|боцмане|бараке|архиве|базаре|рубеже|монастыре|пришелце|гноме|конверте|люке|аэропорте|подполковнике|налоге|полотенце|фашисте|флоте|технике|охраннике|бароне|коменданте|квартале|приступе|определении|образце|напитке|чтении|овраге|оркестре|визите|большевике|термине|интервье|гараже|кризисе|совещании|живом|котелке|ремонте|авторитете|проводе|англичанине|наступлении|объеме|щите|стаде|признании|маге|обращении|гене|пузыре|испытании|прыжке|коллективе|хоре|заказе|свидетельстве|деятеле|бокале|кране|проспекте|братце|маршруте|аресте|китаце|капитале|заключенноме|описании|замысел|хуторе|матросе|сынке|ноле|протоколе|трамвае|маршале|интеллигенте|пустяке|растении|советнике|преимуществе|велосипеде|колодце|кончике|холодильнике|исходе|стихотворении|перерыве|губернаторе|яде|хоббите|бинокле|килограмме|марше|чайнике|тракторе|замечании|рабе|заведении|знамя|фрукте|мотоцикле|мероприятии|чине|шпионе|дубе|столетии|партизане|незнакомце|младенце|эпизоде|преподавателе|племя|томе|диск|пациенте|оттенке|гусе|инвалиде|боевике|очаге|французе|отражении|котел|сценарии|официанте|обвинении|школьнике|рюкзаке|осел|баране|обороте|куполе|приглашении|пионере|приговоре|побеге|учебнике|котенке|порошке|посольстве|окурке|мяче|аэродроме|разряде|объявлении|десятилетии|пейзаже|огурце|пацане|партнере|шлеме|продавце|гнезде|казаке|пруде|блокноте|лозунге|покойнике|снимке|священнике|обитателе|отверстии|наборе|разбойнике|танцоре|утверждении|конкурсе|толчке|батюшке|салоне|баке|сантиметре|грамме|пилоте|рабочеме|предположении|покупателе|градусе|комаре|флаге|всаднике|барьере|историке|дымке|офисе|поваре|негодяе|прогнозе|провале|негре|дровосеке|введении|округе|переводчике|японце|горшке|плакате|сорте|фонарике|мундире|профессионале|катере|шарике|бассейне|методе|человечеке|красавце|правителе|заряде|ребре|обломке|дипломе|указе|обещании|чудаке|паренек|семействе|царстве|фонтане|жилце|расследовании|удаве|выпуске|хирурге|символе|разводе|заведующеме|регионе|защитнике|секторе|санитаре|греке|потомке|сочетании|постановлении|самоубийстве|сейфе|блине|предателе|купце|демократе|факультете|солдатике|паровозе|призраке|соборе|соединении|скафандре|особняке|изделии|землянине|строении|диагнозе|чудовище|букете|кредите|эшелоне|копье|матче|щенке|тигре|аргументе|полотне|пропуске|микрофоне|игроке|новичке|парнишке|поручении|торговце|строителе|знакомоме|слушателе|'

zh_i = '|жизнь|дверь|работа|сила|женщина|ночь|война|минута|жена|страна|дорога|комната|часть|книга|улица|душа|мысль|стена|мама|спина|смерть|девушка|власть|система|квартира|любовь|школа|неделя|семья|группа|газета|собака|форма|армия|рота|гора|река|мера|вещь|причина|черта|девочка|глава|партия|проблема|пара|деревня|цель|бутылка|картина|встреча|игра|трубка|кухня|компания|идея|болезнь|роль|точка|звезда|фамилия|секунда|дочь|революция|сестра|ситуация|граница|тень|лошадь|площадь|радость|карта|цена|область|крыша|дама|рыба|бабушка|птица|зима|кровать|лестница|статья|станция|команда|операция|тема|волна|задача|старуха|тетя|пауза|сотня|степень|фигура|культура|труба|масса|линия|лодка|весна|фотография|сцена|беда|фирма|организация|ошибка|камера|победа|фраза|кость|личность|столица|попытка|шутка|страница|скорость|сигарета|пуля|книжка|больница|тюрьма|кошка|планета|палатка|доска|постель|сумка|жертва|территория|тайна|песня|осень|поверхность|церковь|ручка|хозяйка|опасность|способность|муха|зона|капля|среда|площадка|охота|бровь|клетка|обстановка|штука|основа|дача|тревога|куртка|изба|вершина|рубашка|стенка|луна|гостиница|беседа|лапа|шапка|бабка|должность|истина|позиция|морда|записка|могила|буква|реакция|пила|обезьяна|бригада|краска|разница|куча|полоса|повесть|теория|ткань|база|шинель|комиссия|палка|колонна|надпись|тарелка|подруга|сущность|батарея|девица|мечта|дочка|королева|картошка|девчонка|просьба|сказка|борода|пачка|привычка|сумма|поездка|шляпа|кабина|запись|подробность|ракета|смена|эпоха|ветка|скала|обида|особенность|печка|печать|рана|коробка|цифра|корова|бумажка|профессия|разведка|яма|цепь|лампа|доля|старушка|потеря|дверца|норма|ложка|зарплата|веревка|баня|библиотека|сеть|функция|башня|структура|сфера|угроза|подушка|тетка|дивизия|деталь|новость|передача|редакция|свадьба|лаборатория|бомба|карточка|девка|винтовка|щель|туча|марка|папка|услуга|мина|модель|лекция|печь|река|речка|республика|невеста|виза|обязанность|койка|рукопись|дура|экспедиция|спичка|лопата|кнопка|дорожка|свинья|роза|шкура|контора|палата|лента|рубаха|оболочка|пустыня|молния|атмосфера|оценка|остановка|копейка|версия|ножка|цивилизация|драка|тряпка|мышца|нация|зависимость|империя|величина|крышка|стрела|лавка|ступенька|поза|сосна|перемена|акция|суббота|гимнастерка|папироса|рюмка|свеча|решетка|строка|справка|рамка|долина|чашка|легенда|жидкость|мышка|пещера|майка|схема|четверть|учительница|подпись|змея|картинка|соседка|ветвь|стойка|плита|спальня|лампочка|туфля|пуговица|благодарность|пьеса|примета|игрушка|спинка|проверка|ведьма|палуба|почта|академия|физиономия|струя|теща|процедура|лужа|юбка|маска|атака|реформа|установка|кисть|телеграмма|дыра|машинка|прогулка|натура|фуражка|командировка|вена|палочка|катастрофа|трагедия|реклама|калитка|шуба|выставка|кишка|цепочка|монета|перчатка|дата|каюта|категория|фабрика|премия|казарма|ставка|манера|пасть|медаль|биография|тетрадь|ванна|жалоба|награда|печень|характеристика|повязка|крепость|трудность|инструкция|вселенная|тварь|лыжа|гитара|вспышка|администрация|петля|простыня|витрина|ресница|технология|загадка|хата|елка|травма|покупка|специальность|скамья|серия|копия|тропинка|рама|буря|ягода|ограда|тонна|мышь|ступень|трасса|смесь|граната|формула|эмоция|тройка|порода|корзина|конференция|доза|пленка|неудача|таблетка|фигурка|береза|секретарша|пропасть|полоска|телега|кастрюля|дырка|матушка|коза|касса|скатерть|кампания|крыса|съемка|икона|местность|медсестра|мелодия|грань|курица|посадка|нитка|банда|инфекция|стая|усадьба|траншея|табуретка|пробка|провинция|порция|почка|конфета|сетка|заря|матка|минутка|мать|пластинка|заслуга|будка|молитва|кличка|веранда|битва|публикация|язва|груша|гроза|шахта|инициатива|единица|ссылка|роща|тропа|казнь|группировка|заметка|принцесса|валюта|складка|трещина|аллея|поляна|актриса|кукла|конструкция|концепция|бабочка|студия|скрипка|песенка|редкость|премьера|зажигалка|претензия|стоянка|стадия|верхушка|национальность|платформа|верста|подружка|гусеница|отставка|рыбка|сопка|тумбочка|стрекоза|тысяча|миля|'
...
#  ('⁻', 'минус '),
  ...
  (r'\b([Кк]о?|рав[нагеимоыхя]{2,4})( \d+ )((|кило|санти|милли)метр|(|кило|милли)грамм)\b', r'\1\2\3у'),
  (r'\b([Кк]о?|рав[нагеимоыхя]{2,4})( \d+ )((|кило|санти|милли)метр|(|кило|милли)грамм)[аво]{1,2}\b', r'\1\2\3ам'),
  (r'\b([Кк]о?|рав[нагеимоыхя]{2,4})( \d+ )(тонн|минут|секунд)а\b', r'\1\2\3е'),
  (r'\b([Кк]о?|рав[нагеимоыхя]{2,4})( \d+ )(тонн|минут|секунд)[ы]?\b', r'\1\2\3ам'),
  (r'\b([Вв]|[Дд]о)( \d+ )((|кило|санти|милли)метр|(|кило|милли)грамм)\b', r'\1\2\3е'),
  (r'\b([Вв]|[Дд]о)( \d+ )((|кило|санти|милли)метр|(|кило|милли)грамм)[аво]{1,2}\b', r'\1\2\3ах'),
...
#        text = text.replace(m.group(), m.group(1) + ' ' + minutes, 1)
    ...
    for m in finditer(r'(\d+)-(часов[агеиймоухыюя]{2,3}|(силь|тон|каналь|странич|тысяч|миллион|миллиард|процент|секунд|минут|месяч|недель)н[агеиймоухыюя]{2,3}|лет[геиймнохюя]{2,4}|(|кило)граммов|(|кило|милли|санти)метров[агеиймоухыюя]{2,3})\b', text):
        if m.group(1) == '100':
            num = 'сто'
    ...
    for m in finditer(r'\b([Вв] течение )(\d+) ?- ?(\d+) ([а-я]+)\b', text):
    ...
    for m in finditer(r'\b([Бб]олее|[Мм]енее|[Оо]коло|[Сс]выше|[Дд]ля|[Дд]о|[Ии]з|[Оо]т|[Бб]ез|[Уу]|[Вв] течение|[Пп]орядка|[Пп]осле|[Пп]ротив|достиг[алнш][веиотуьщюя]{1,4}) (\d+) ([а-я]+)\b', text):
        if ms_r.find('|' + m.group(3) + '|') != -1:
            ...
            number = cardinal(m.group(2), r_ca)
        text = text.replace(m.group(), m.group(1) + ' ' + number + '_' + m.group(3), 1)
    ...
    # Дательный падеж
    for m in finditer(r'\b([Кк]о? |[Пп]о |рав[нагеимоыхя]{2,4} )(\d+) ([а-я]+([аиыя]м|у|ю|е|и))\b', text):
        number = ''
        if m.group(3)[-1] == 'м':
    ...
    # Предложный падеж
    for m in finditer(r'\b([Вв]о? |[Нн]а |[Оо]б? |[Пп]ри )(\d+) ([а-я]+([аиыя]х|е|и|у))\b', text):
        number = ''
        if m.group(3)[-1] == 'х':
            if m.group(2)[-1] != '1' or (len(m.group(2)) > 1 and m.group(2)[-2] == '1'):
