...
# Формы единиц измерения (TODO нужно указать как они задаются)
forms = {
...
def txt_prep(text):
    ...
    #letternames = ('альфа', 'бета', 'гамма', 'дельта', 'эпсилон', 'дзета', 'эта', 'тета', 'йота',
    #               'каппа', 'лямбда', 'мю', 'ню', 'кси', 'омикрон', 'пи', 'ро', 'сигма', 'тау',
    #               'ипсилон', 'фи', 'хи', 'пси', 'омега', 'сигма')
