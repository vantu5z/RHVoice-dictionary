...
zh_v = r'(работу|силу|женщину|войну|минуту|жену|страну|комнату|улицу|стену|маму|спину|систему|квартиру|группу|газету|меру|жизнь|дверь|ночь|часть|мысль|дорогу|книгу|душу|смерть|девушку|власть|любовь|школу|неделю|семью|собаку|форму|армию|роту|гору|реку|вещь|причину|черту|девочку|главу|партию|проблему|пару|деревню|цель|бутылку|картину|встречу|игру|трубку|кухню|компанию|идею|болезнь|роль|точку|звезду|фамилию|секунду|дочь|революцию|сестру|ситуацию|границу|тень|лошадь|площадь|радость|карту|цену|область|крышу|даму|рыбу|бабушку|птицу|зиму|кровать|лестницу|статью|станцию|команду|операцию|тему|волну|задачу|старуху|тетю|паузу|сотню|степеинь|фигуру|культуру|трубу|массу|линию|лодку|весну|фотографию|сцену|беду|фирму|организацию|ошибку|камеру|победу|фразу|кость|личность|столицу|попытку|шутку|страницу|скорость|сигарету|пулю|книжку|больницу|тюрьму|кошку|планету|палатку|доску|постель|сумку|жертву|территорию|тайну|песню|осень|поверхность|церкв|ручку|хозяйку|опасность|способность|муху|зону|каплю|среду|площадку|охоту|бровь|клетку|обстановку|штуку|основу|дачу|тревогу|куртку|избу|вершину|рубашку|стенку|луну|гостиницу|беседу|лапу|шапку|бабку|должность|истину|позицию|морду|записку|могилу|букву|реакцию|пилу|обезьяну|бригаду|краску|разницу|кучу|полосу|повесть|теорию|ткань|базу|шинель|комиссию|палку|колонну|надпис|тарелку|подругу|сущность|батарею|девицу|мечту|дочку|королеву|девчонку|просьбу|сказку|бороду|пачку|привычку|сумму|поездку|шляпу|кабину|запись|подробность|ракету|смену|эпоху|ветку|скалу|обиду|особенность|печку|печать|рану|коробку|цифру|корову|бумажку|профессию|разведку|яму|цепь|лампу|долю|старушку|потерю|дверцу|норму|ложку|зарплату|веревку|баню|библиотеку|сет|функцию|башню|структуру|сферу|угрозу|подушку|тетку|дивизию|деталь|новость|передачу|редакцию|свадьбу|лабораторию|бомбу|карточку|девку|винтовку|щель|тучу|марку|папку|услугу|мину|модель|лекцию|печь|речку|республику|невесту|визу|обязанность|койку|рукопись|дуру|экспедицию|спичку|лопату|кнопку|дорожку|свинью|розу|шкуру|контору|палату|ленту|рубаху|оболочку|пустыню|молнию|атмосферу|оценку|остановку|копейку|версию|ножку|цивилизацию|драку|тряпку|мышцу|нацию|зависимость|империю|величину|крышку|стрелу|лавку|ступеньку|позу|сосну|перемену|акцию|субботу|гимнастерку|папиросу|рюмку|свечу|решетку|строку|справку|рамку|долину|чашку|легенду|жидкость|мышку|пещеру|майку|схему|четверт|учительницу|подпись|змею|картинку|соседку|ветв|стойку|плиту|спальню|лампочку|туфлю|пуговицу|благодарность|пьесу|примету|игрушку|спинку|проверку|ведьму|палубу|почту|академию|физиономию|струю|тещу|процедуру|лужу|юбку|маску|атаку|реформу|установку|кисть|телеграмму|дыру|машинку|прогулку|натуру|фуражку|командировку|вену|палочку|катастрофу|трагедию|рекламу|калитку|шубу|выставку|кишку|цепочку|монету|перчатку|дату|каюту|категорию|фабрику|премию|казарму|ставку|манеру|пасть|медаль|биографию|тетрад|ванну|жалобу|награду|печень|характеристику|повязку|крепость|трудность|инструкцию|вселенной|твар|лыжу|гитару|вспышку|администрацию|петлю|простыню|витрину|ресницу|технологию|загадку|хату|елку|травму|покупку|специальность|скамью|серию|копию|тропинку|раму|бурю|ягоду|ограду|тонну|мышь|ступень|трассу|смесь|гранату|формулу|эмоцию|тройку|породу|корзину|конференцию|дозу|пленку|неудачу|таблетку|фигурку|березу|секретаршу|пропасть|полоску|телегу|кастрюлю|дырку|матушку|козу|кассу|скатерт|кампанию|крысу|съемку|икону|местность|медсестру|мелодию|грань|курицу|посадку|нитку|банду|инфекцию|стаю|усадьбу|траншею|табуретку|пробку|провинцию|порцию|почку|конфету|сетку|зарю|матку|минутку|пластинку|заслугу|будку|молитву|кличку|веранду|битву|публикацию|язву|грушу|грозу|шахту|инициативу|единицу|ссылку|рощу|тропу|казнь|группировку|заметку|принцессу|валюту|складку|трещину|аллею|поляну|актрису|куклу|конструкцию|концепцию|бабочку|студию|скрипку|песенку|редкость|премьеру|зажигалку|претензию|стоянку|стадию|верхушку|национальность|платформу|версту|подружку|гусеницу|отставку|рыбку|сопку|тумбочку|стрекозу|милю)'

zh_p = 'работе|силе|женщине|войне|минуте|жене|стране|комнате|улице|стене|маме|спине|системе|квартире|группе|газете|мере|жизни|двери|ночи|части|мысли|дороге|книге|душе|смерти|девушке|власти|любови|школе|неделе|семье|собаке|форме|армии|роте|горе|реке|вещи|причине|черте|девочке|главе|партии|проблеме|паре|деревне|цели|бутылке|картине|встрече|игре|трубке|кухне|компании|идее|болезни|роли|точке|звезде|фамилии|секунде|дочери|революции|сестре|ситуации|границе|тени|лошади|площади|радости|карте|цене|области|крыше|даме|рыбе|бабушке|птице|зиме|кровати|лестнице|статье|станции|команде|операции|теме|волне|задаче|старухе|тете|паузе|сотне|степеини|фигуре|культуре|трубе|массе|линии|лодке|весне|фотографии|сцене|беде|фирме|организации|ошибке|камере|победе|фразе|кости|личности|столице|попытке|шутке|странице|скорости|сигарете|пуле|книжке|больнице|тюрьме|кошке|планете|палатке|доске|постели|сумке|жертве|территории|тайне|песне|осени|поверхности|церкви|ручке|хозяйке|опасности|способности|мухе|зоне|капле|среде|площадке|охоте|брови|клетке|обстановке|штуке|основе|даче|тревоге|куртке|избе|вершине|рубашке|стенке|луне|гостинице|беседе|лапе|шапке|бабке|должности|истине|позиции|морде|записке|могиле|букве|реакции|пиле|обезьяне|бригаде|краске|разнице|куче|полосе|повести|теории|ткани|базе|шинели|комиссии|палке|колонне|надпис|тарелке|подруге|сущности|батарее|девице|мечте|дочке|королеве|девчонке|просьбе|сказке|бороде|пачке|привычке|сумме|поездке|шляпе|кабине|записи|подробности|ракете|смене|эпохе|ветке|скале|обиде|особенности|печке|печати|ране|коробке|цифре|корове|бумажке|профессии|разведке|яме|цепи|лампе|доле|старушке|потере|дверце|норме|ложке|зарплате|веревке|бане|библиотеке|сети|функции|башне|структуре|сфере|угрозе|подушке|тетке|дивизии|детали|новости|передаче|редакции|свадьбе|лаборатории|бомбе|карточке|девке|винтовке|щели|туче|марке|папке|услуге|мине|модели|лекции|печи|речке|республике|невесте|визе|обязанности|койке|рукописи|дуре|экспедиции|спичке|лопате|кнопке|дорожке|свинье|розе|шкуре|конторе|палате|ленте|рубахе|оболочке|пустыне|молнии|атмосфере|оценке|остановке|копейке|версии|ножке|цивилизации|драке|тряпке|мышце|нации|зависимости|империи|величине|крышке|стреле|лавке|ступеньке|позе|сосне|перемене|акции|субботе|гимнастерке|папиросе|рюмке|свече|решетке|строке|справке|рамке|долине|чашке|легенде|жидкости|мышке|пещере|майке|схеме|четверти|учительнице|подписи|змее|картинке|соседке|ветви|стойке|плите|спальне|лампочке|туфле|пуговице|благодарности|пьесе|примете|игрушке|спинке|проверке|ведьме|палубе|почте|академии|физиономии|струе|теще|процедуре|луже|юбке|маске|атаке|реформе|установке|прихожей|кисти|телеграмме|дыре|машинке|прогулке|натуре|фуражке|командировке|вене|палочке|катастрофе|трагедии|рекламе|калитке|шубе|выставке|кишке|цепочке|монете|перчатке|дате|каюте|категории|фабрике|премии|казарме|ставке|манере|пасти|медали|биографии|тетради|ванне|жалобе|награде|печени|характеристике|повязке|крепости|трудности|инструкции|вселенной|твар|лыже|гитаре|вспышке|администрации|петле|простыне|витрине|реснице|технологии|загадке|хате|елке|травме|покупке|специальности|скамье|серии|копии|тропинке|раме|буре|ягоде|ограде|тонне|мыши|ступени|трассе|смеси|гранате|формуле|эмоции|тройке|породе|корзине|конференции|дозе|пленке|неудаче|таблетке|фигурке|березе|секретарше|пропасти|полоске|телеге|кастрюле|дырке|матушке|козе|кассе|скатерти|кампании|крысе|съемке|иконе|местности|медсестре|мелодии|грани|курице|посадке|нитке|банде|инфекции|стае|усадьбе|траншее|табуретке|пробке|провинции|порции|почке|конфете|сетке|заре|матке|минутке|пластинке|заслуге|будке|молитве|кличке|веранде|битве|публикации|язве|груше|грозе|шахте|инициативе|единице|ссылке|роще|тропе|казни|группировке|заметке|принцессе|валюте|складке|трещине|аллее|поляне|актрисе|кукле|конструкции|концепции|бабочке|студии|скрипке|песенке|редкости|премьере|зажигалке|претензии|стоянке|стадии|верхушке|национальности|платформе|версте|подружке|гусенице|отставке|рыбке|сопке|тумбочке|стрекозе|миле'
...
presamples = (
  ...
  (r'\b(в|вв|г|гг|д|п|с|э|долл|руб|кв|обл|тыс|ш|шт)(\. [А-Я][ а-я]+)', r'\1.\2'),
...
#        text = text.replace(m.group(), m.group(1) + ' ' + minutes, 1)
    ...
    for m in finditer(r'\b()(\d+)( [а-я]+)(ми|[ео]м|[ео]й|ью)\b', text):
    ...
    for m in finditer(r'\b([Вв] |[Нн]а |[Оо]б? |[Пп]ри )(\d+) ([а-я]+(х|е|и))\b', text):
    ...
    for m in finditer(r'([Вв] |[Зз]а |[Нн]а |[Пп]ро |[Чч]ерез )(\d*[02-9][1-4]|[1-4]) ' + mu_v, text):
        number = feminin(m.group(2))
        if m.group(2)[-1] == '1':
            number = number[:-1] + 'ого '
        elif m.group(2)[-1] == '2':
            number = number[:-1] + 'ух '
    ...
    for m in finditer(r'([Вв] |[Зз]а |[Нн]а |[Пп]ро |[Чч]ерез )(\d*[02-9]1|1) ' + zh_v, text):
        text = text.replace(m.group(), m.group(1) + feminin(m.group(2))[:-1] + 'у ' + m.group(3), 1)
