...
# именительный, родительный, дательный, твворительный, предложный
forms = {
  ...
  'см²': ('сантиметр квадратный', 'сантиметров квадратных', 'сантиметра квадратного', 'сантиметров квадратных', 'сантиметру квадратному', 'сантиметрами квадратным', 'сантиметром квадратным', 'сантиметрами квадратными', 'сантиметре квадратном', 'сантиметрах квадратных'),
  ...
  'мм³': ('миллиметр кубический', 'миллиметров кубических', 'миллиметра кубического', 'миллиметров кубических', 'миллиметру кубическому', 'миллиметрам кубическим', 'миллиметром кубическим', 'миллиметреми кубическими', 'миллиметре кубическом', 'миллиметрах кубических'),
  'см³': ('сантиметр кубический', 'сантиметров кубических', 'сантиметра кубического', 'сантиметров кубических', 'сантиметру кубическому', 'сантиметрам кубическим', 'сантиметрм кубическим', 'сантиметрами кубическими', 'сантиметре кубическом', 'сантиметрах кубических'),
...
#        text = text.replace(m.group(), m.group(1) + ' ' + minutes, 1)
    ...
    for m in finditer(r'\b([Зз]а |[Нн]ад |[Пп]од |[Пп]еред |[Сс] )(\d+)( [а-я]+)(ми|[ео]м|[ео]й|ью)\b', text):
        number = ''
        if m.group(3)[-1] == 'и' or m.group(3)[-1] == 'м':
            number = cardinal(m.group(2), t_ca)
        else:
            if (m.group(3)[-1] == 'й' or m.group(3)[-1] == 'ю') and (m.group(2) == '1' or (len(m.group(2)) > 1 and m.group(2)[-2] != '1' and m.group(2)[-1] == '1')):
                number = cardinal(m.group(2), t_ca)[:-2] + 'ой'
        if number != '':
            text = text.replace(m.group(), m.group(1) + number + m.group(3), 1)
